...
Despite the growth of self-driving cars, there are still complex moral questions [e.g., @Maxmen2018SelfDrivingCarEthics; @Vemoori2024EthicalDilemmasForbes] and uncertainty about the general readiness and experience individuals have driving with this new technology. David Li, co-founder of Hesai, a remote-sensing technology company, said that the adoption of self-driving cars are not just a question about technology development, but "it is a social question, it is a regulatory question, it is a political question" [@White2025HesaiSensors]. Therefore, it is important to understand how people, some of who may already will one day purchase a self-driving car, view this technological phenomenon.
...
> *The **predictedodds** a respondent who agrees technology makes life easier is comfortable with driverless cars 2.012 (* $e^{0.699}$*) **times** the predicted odds of a respondent who is neutral about whether technology makes life easier.*[^11-logistic-6]
...
[^11-logistic-9]: Note the difference the result here and the model output is because the model output is computed using exact values of $\hat{\beta}_j$ and $SE_{\hat{\beta}_j}$.
...
The code for simulation-based inference for logistic regression is the same as the code for linear regression introduced in @sec-slr-R. Behind the scenes, the functions in the **infer** R package use the response variable to determine whether to fit a linear or logistic regression model.
