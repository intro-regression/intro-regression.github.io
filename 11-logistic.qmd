...
[^11-logistic-7]: When age increases by 5, the log odds are expected to decrease by `r round(abs(-0.015 * 5), 3)` ($-0.015 \times 5$ ) . The expected odds change by a multiplicative factor of `r round(exp(-0.015 * 5), 3)` ( $e^{-0.015 \times 5}$).
