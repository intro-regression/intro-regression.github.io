...
The dataset `ncaa-basketball-DI-2023-2024.csv` contains data from the 2023 - 2024 academic year. We will use the following variables that have been derived from variables in the EADA.
...
#| tbl-cap: "Output of the model with log-transformed `enrollment_th`"
#| eval: true
...
#| tbl-cap: Output of the model with log-transformed expenditure and log-transformed enrollment
