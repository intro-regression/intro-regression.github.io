...
#| tbl-cap: Output of the model using various characteristics to explain variability in weight of young lemurs
#| echo: false
...
#| tbl-cap: "Model predicting lemurs weight with `age` recorded in years." 
lemurs <- lemurs |>
