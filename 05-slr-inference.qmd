...
In @sec-slr-specify, we introduced the statistical model for simple linear regression $$Y = \beta_0 + \beta_1 X + \epsilon \hspace{8mm} \epsilon \sim N(0, \sigma^2_{\epsilon})$$ {#eq-slr-model-ch5}
