...
Recall from @sec-construct-boostrap-ci, we generated 1000 bootstrap samples. The distribution of the predictions from the 1000 bootstrap samples when `per_capita_spend = 150` is in @fig-bootstrap-pred-150. The points on the distribution span the middle 95% of the distribution are marked on the visualization.
