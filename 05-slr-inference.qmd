...
#| tbl-cap: "Estimated slope, intercept, and prediction for `spend = 150` from first five bootstrap samples"
...
#| fig-cap: "Bootstrap distribution of predictions when `spend = 150` with bounds for the 95% interval"
...
#| fig-cap: "Compute the p-value using t-distribution with 95 df"
...
#| tbl-cap: "Standard errors and 95% intervals for the predicted mean response and individual response when `per_capita_expend = 150`" 
