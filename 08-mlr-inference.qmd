...
The formulas for standard error utilize the matrix notation for regression, so we present those in Appendix \[INSERT REF\]. @tbl-lemur-prediction-intervals shows the standard errors and intervals for the two types of predictions for a 10-month old male lemur from the VRUB taxon who was born in a litter of 4 lemurs.
...
- link to notes for equations: <https://sta221-sp26.github.io/hw/hw-03.html#exercise-9>
