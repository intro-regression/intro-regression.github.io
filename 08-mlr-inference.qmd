...
```{r}
#| label: fig-lemurs-matrix
#| fig-cap: Relationships between variables in original lemurs data 

lemurs_sample_young |>
  ggpairs(columns = 4:8, progress = FALSE, 
          upper = "blank", 
          lower = list(combo = "box_no_facet", discrete = "facetbar")
  )
```
...
```{r}
#| label: fig-lemurs-matrix-weight
#| fig-cap: Relationships between variables in one sample with weight permuted
...
```{r}
#| label: fig-lemurs-matrix-age
#| fig-cap: Relationships between variables in one sample with age permuted
