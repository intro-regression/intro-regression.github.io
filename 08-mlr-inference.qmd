...
@fig-lemurs-matrix is a scatterplot matrix that shows the relationship between each pair of variables in the `lemurs` data frame. We'll refer to this as we introduce the two permutation strategies to show how each strategy changes the relationships in the data.
