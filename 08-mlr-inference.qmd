...
<!--# need to rewrite this. We are only going to discuss permutation of the response variable (put Manly citations - 1997 book and the updated edition). Anderson and Legendre 1999 paper said that this method in most cases, this method showed the same Type 1 error rate and power as other methods in most cases. The power was destablized when there was an extreme outlier, so we will point the reader to alternative permutation sampling methods at the end of this section.-->

<!--# add reference at the end for further reading. include the citations for the permuting the residuals. link to anderson and manly text for indepth discussion of these methods.-->
...
\[INSERT FIGURE OF AGE VS. WEIGHT - ORIGINAL + 9 RANDOMLY SELECTED PERMUTATION SAMPLES\]
...
- maybe jo hardin's paper on exchangeability
