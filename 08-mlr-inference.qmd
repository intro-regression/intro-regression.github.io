...
- Which confidence level will you choose to get the most precise interval?[^08-mlr-inference-9]
:::
...
Because we expect at least some correlation between the predictors, we conclude that concerning multicollinearity exists if VIF is 10 or greater. @tbl-lemur-vif are the VIF for the predictors in @tbl-lemur-model-inf.
