...
#| tbl-cap: " Glimpse of `recipes` data\""
...
#| tbl-cap: "Glimpse of `recipes` data with correct formats for `chef_john` and `month`"
...
#| fig-cap: "Visualizations of the distribution of `season`"
#| fig-subcap: 
#|   - "Bar chart"
#|   - "Pie chart"
#|   - "Waffle chart"
...
#| fig-cap: "Original versus truncated distribution of `cook_time`" 
#| fig-subcap: 
#|   - "All observations"
...
#| fig-cap: "Scatterplot of the relationship between `calories` and `protein`"
...
#| tbl-cap: "Summary statistics for `avg_rating` by levels of `chef_john`"
...
#| fig-cap: "Visualizations of the relationship between `chef_john` and `season`"
#| fig-subcap: 
#|   - "Grouped bar chart"
#|   - "Segmented bar plot"
#|   - "Mosaic plot"
