...
The standard error $SE$ in @eq-pred-intervals-appendix is defined based on whether we are quantifying uncertainty in the estimated mean response or prediction for an individual observation. The standard error for the estimated mean response is
