...
[^12-logistic-prediction-2]: These values may differ slightly from the values in the the table, because we are computing predictions using rounded coefficient.
