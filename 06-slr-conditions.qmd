...
::: {.yourturn latex=""}
There are `r n_large_leverage` observations that have large values for the leverage. What does it mean for an observation to have "high leverage" in the context of the coffee data?
:::
