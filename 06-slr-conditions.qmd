...
In the coffee ratings data, we consider if there is a potential cluster effect based on where the coffee beans were grown. <!--# add graph for the distribution by country. Need to restructure the data--> Based on the description of the coffee data, we conclude that the independence condition is satisfied. We do not have evidence of a serial or cluster effect in the data description.
