...
Here we have relied on the default settings for the multiple imputation, but `mice()` contains many arguments to customize the imputation. We refer the reader to the package documentation and additional resources for more information.

Further reading

Further reading: Gelman and Hill book Chapter 25. Add little and rubin (2002) book here. Rubin 1987 and 1996 for more on multiple imputation.
