...
- Approaches for dealing with missingness - remove the missingness or impute missing values - Illustrate what all these mean in the context of the recipes data

  - Complete case analysis - only use the observations that have complete data.

    - This is primarily what we have done in this text in order to focus on the regression methods

    - Note - R does this automatically when fitting models. If you have observations with missing values for the response or one or more predictors, R will quietly drop these observations. Thus, it is even more important to understand the missingness in the data at the beginning of the analysis.
